...
export function anthropicToolToOpenAIChatTool(tool: AnthropicTool): OpenAIChatTool {
  return {
    ...
    function: {
      ...
      parameters: toOpenAIParameters(tool.input_schema) as unknown as OpenAIChatTool['function']['parameters'],
      strict: tool.strict
    }
  }
}
...
export function anthropicToolToResponsesTool(tool: AnthropicTool): OpenAIResponsesFunctionTool {
  return {
    ...
    name: tool.name,
    description: tool.description || '',
    parameters: toOpenAIParameters(tool.input_schema) as unknown as OpenAIResponsesFunctionTool['parameters'],
    strict: tool.strict
  }
}
