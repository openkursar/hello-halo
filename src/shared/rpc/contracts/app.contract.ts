...
export const appRpc = {
  ...
  appStartRun: rawRpcMethod('app:start-run'),
  appGetState: rawRpcMethod('app:get-state'),
  appGetStudioSummary: rawRpcMethod('app:get-studio-summary'),
  appListPeople: rawRpcMethod('app:list-people'),
  appGetAllStates: rawRpcMethod('app:get-all-states'),
  appGetPendingEntries: rawRpcMethod('app:get-pending-entries'),
  ...
  appPreviewSpaceChange: rawRpcMethod('app:preview-space-change'),
  appGetActivity: rawRpcMethod('app:get-activity'),
  appGetActivityEntry: rawRpcMethod('app:get-activity-entry'),
