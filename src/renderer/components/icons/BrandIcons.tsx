...
/**
 * Claude (Anthropic) — the starburst mark. Single-color (`currentColor`) so it
 * takes the call site's tint, like every other brand mark here.
 */
export const ClaudeIcon: FC<BrandIconProps> = ({ size = 20, className, style }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
/** OpenAI — the blossom mark, shown for the ChatGPT subscription login. */
export const OpenAIIcon: FC<BrandIconProps> = ({ size = 20, className, style }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
const brandIcons: Record<string, FC<BrandIconProps>> = {
  ...
  'tencent': WeChatIcon,
  'claude': ClaudeIcon,
  [CHATGPT_PROVIDER_ID]: OpenAIIcon
}
