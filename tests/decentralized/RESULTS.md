...
> Run at 2026-07-17T07:57:42.847Z · cluster=5 ready node(s) · model key present=true
...
| A2 | ✅ PASS | identity before=id_RYS4Q2V8g_nMwkwfXLuYFXeICqOU74ZZ after=id_RYS4Q2V8g_nMwkwfXLuYFXeICqOU74ZZ |
| A3 | ✅ PASS | 5 nodes, uniquePorts=true, isolatedDataDirs=true |
| B1 | ✅ PASS | all 5 nodes agree: 6 members, lead=79e66586-5500-43ff-939b-3f122a53adef; host sees remote member=true |
| B5 | ✅ PASS | 5 nodes: all 5 nodes agree: 6 members, lead=79e66586-5500-43ff-939b-3f122a53adef |
| B2 | ✅ PASS | jti1=83821f82-ff02-4469-9d65-b36a1600733d jti2=83821f82-ff02-4469-9d65-b36a1600733d tokenSame=true |
| B3 | ✅ PASS | revokedJoinRejected=true (node-3 POST /api/teams/3f1f4e87-0067-41da-93e8-c2c641f7275e/join → AUTH_REJECTED (status 200)); seatedMemberRetained=true |
...
| D1 | ✅ PASS | all nodes converged to new lead=39532878-c20e-4665-9a48-8af3acd48661 |
| D2 | ✅ PASS | all 3 nodes agree: 5 members, lead=39532878-c20e-4665-9a48-8af3acd48661 |
| D3 | ✅ PASS | removed b01c7d54-a900-4f08-843b-bef21b5be94e; all 3 nodes agree: 4 members, lead=39532878-c20e-4665-9a48-8af3acd48661 |
...
| E1 | ✅ PASS | all nodes status=running, epoch=d0b65379-7a99-49fd-9956-7b4bd3afaef6 byte-identical |
...
| G3 | ✅ PASS | owner-down history fetch took 8011ms status=200 stale=true (expect <12s + stale-cache or neutral) |
...
| H7 | ✅ PASS | send acked in 8063ms status=200 (server-side dispatch ack; true UI optimistic echo is renderer-only) |
...
| K1 | ✅ PASS | 50 concurrent sends: transportOk=true repliedWithContent=50 deliveredInTranscript=50/50 elapsed=3426ms alive=true (coalescing per-send-reply semantics flagged in RESULTS for product review) |
...
| K3 | ✅ PASS | 5-node office roster: all 5 nodes agree: 6 members, lead=ec45521d-4aba-40f6-b7e5-38c9e763b4ad |
| K4 | ✅ PASS | after 8 join/leave cycles: all 1 nodes agree: 2 members, lead=1144d494-a722-4dd7-8b75-8cfc405353d6; lingering remote members=0 (expect 0) |
