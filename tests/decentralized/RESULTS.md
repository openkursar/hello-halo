...
> Run at 2026-09-16T10:02:59.940Z · cluster=5 ready node(s) · model key present=true
...
- **H1** — no consistent reply within 90s
...
- **K1** — 50 concurrent sends: transportOk=true repliedWithContent=0 deliveredInTranscript=<N/50 elapsed=45ms alive=true (coalescing per-send-reply semantics flagged in RESULTS for product review)
...
| A2 | ✅ PASS | identity before=id_-cbQKxzh8qd8dr-6FOZBF5YpDfiXNuxQ after=id_-cbQKxzh8qd8dr-6FOZBF5YpDfiXNuxQ |
| A3 | ✅ PASS | 5 nodes, uniquePorts=true, isolatedDataDirs=true |
| B1 | ✅ PASS | all 5 nodes agree: 6 members, lead=8fb4948e-7466-4d9e-bbb9-39c9e6d297a8; host sees remote member=true |
| B5 | ✅ PASS | 5 nodes: all 5 nodes agree: 6 members, lead=8fb4948e-7466-4d9e-bbb9-39c9e6d297a8 |
| B2 | ✅ PASS | jti1=2306071c-c246-4bd8-8efc-2a72cbdeb2cd jti2=2306071c-c246-4bd8-8efc-2a72cbdeb2cd tokenSame=true |
| B3 | ✅ PASS | revokedJoinRejected=true (node-3 POST /api/teams/0901ba20-8fbf-4b19-8700-f15310d5e1af/join → AUTH_REJECTED (status 200)); seatedMemberRetained=true |
...
| D1 | ✅ PASS | all nodes converged to new lead=6dd46460-7e52-46e9-b474-b44a1349b4c5 |
| D2 | ✅ PASS | all 3 nodes agree: 5 members, lead=6dd46460-7e52-46e9-b474-b44a1349b4c5 |
| D3 | ✅ PASS | removed 1dcc4756-012d-410c-a88b-131e82038e6d; all 3 nodes agree: 4 members, lead=6dd46460-7e52-46e9-b474-b44a1349b4c5 |
...
| E1 | ✅ PASS | all nodes status=running, epoch=b5c91019-33ee-4edc-a491-b6b25c3e1118 byte-identical |
...
| G3 | ✅ PASS | owner-down history fetch took 3ms status=200 rows=2 stale=false (expect <12s + local replica or neutral) |
| G4 | ✅ PASS | non-member appId history request status=404 rejected=true |
| H1 | ❌ FAIL | no consistent reply within 90s |
| H2 | ✅ PASS | transcript content-consistent len=2 across nodes |
| H3 | ✅ PASS | transcript content-consistent len=2 across nodes |
| H7 | ✅ PASS | send acked in 6ms status=200 (server-side dispatch ack; true UI optimistic echo is renderer-only) |
...
| K1 | ⚠️ PARTIAL | 50 concurrent sends: transportOk=true repliedWithContent=0 deliveredInTranscript=<N/50 elapsed=45ms alive=true (coalescing per-send-reply semantics flagged in RESULTS for product review) |
...
| K3 | ✅ PASS | 5-node office roster: all 5 nodes agree: 6 members, lead=0b67ee51-37bf-4e4b-8aa0-d234dedd98f9 |
| K4 | ✅ PASS | after 8 join/leave cycles: all 1 nodes agree: 2 members, lead=993b5c25-cd14-4146-9d93-562add4ef045; lingering remote members=0 (expect 0) |
